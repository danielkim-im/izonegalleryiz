...
public class ExplorePostDetailActivity extends AppCompatActivity {
    ...
    ImageView imgCurrentUser, explorepostImage, imgPostUser;
    TextView txtPostDesc, txtPostTitle, dateTxt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        int nightModeFlags =
                ExplorePostDetailActivity.this.getResources().getConfiguration().uiMode &
        ...
        RvComment.setLayoutManager(new GridLayoutManager(ExplorePostDetailActivity.this, 1, LinearLayoutManager.VERTICAL, false));
        imgCurrentUser = findViewById(R.id.cafe_current_user_img);
        explorepostImage = findViewById(R.id.post_detail_img);
        ...
        dateTxt = findViewById(R.id.explore_post_detail_date_name);
        imgPostUser = findViewById(R.id.explore_post_detail_user_img);
        ...
        Glide.with(this)
                ...
                .into(imgCurrentUser);
        Picasso.get()
                .load(getIntent().getExtras().getString("postImage"))
                .config(Bitmap.Config.RGB_565)
                .into(explorepostImage);
        ...
        Glide.with(this).load(R.drawable.one_reeler_logo).into(imgPostUser);
    ...
    private void downloadImage() {
        ...
        if(ActivityCompat.checkSelfPermission(ExplorePostDetailActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED)
        ...
        if(ActivityCompat.checkSelfPermission(ExplorePostDetailActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED){
            if(SaveImageHelper.imgDownloaded == false){
                AlertDialog dialog = new SpotsDialog(ExplorePostDetailActivity.this);
    ...
    private void iniRvComment() {
        ...
        commentRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                commentAdapter = new CommentAdapter(ExplorePostDetailActivity.this, listComment);
